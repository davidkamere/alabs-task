                ...
                <div className="mb-20 h-20 md:px-40 lg:px-96">
                    ...
                    <form className='relative flex justify-end' onSubmit={handleSubmit}>
                        ...
                        className="
                            ...
                            pl-5
                            rounded-full
                            bg-black bg-opacity-5 backdrop-blur-lg drop-shadow-lg
                            transition
                            ease-in-out
                            m-0
                            focus:border-[#a3d2a0]
                        ...
                        required
                        />
                        <button type='submit' className='rounded-full inset-y-0 absolute z-10 bg-gradient-to-r from-[#adda89] to-[#8dd7d3] flex items-center px-2 m-2 justify-self-end shadow shadow-[white] ml-4 hover:scale-105'>
                            {!loading ? <UploadIcon className='w-6 h-6 text-black'/> :
