            ...
            <nav className="">
                ...
                <ul className="DESKTOP-MENU hidden space-x-7 lg:flex">
                    ...
                    <li>
                        <Link href="/random">
                            <div>
                                <FilmIcon className="transition ease-in-out duration-100 hover:scale-105 h-8 w-8 py-1 hover:cursor-pointer text-black"/>
                            </div>
                        </Link>
                    </li>
                    <li>
                        <Link href={`/profile/${session?.user?.username}`}>
                            <UserCircleIcon className="transition translate-x-1 ease-in-out duration-100 hover:scale-105 h-8 w-8 py-1 hover:cursor-pointer text-black "/>
                        </Link>
                    </li></>} 
                    <li>
