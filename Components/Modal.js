                ...
                <div className="flex items-end justify-center min-h-[650px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        ...
                        sm:p-6">
                            <div>
                                {selectedFile ?
                                <img className="w-full object-contain cursor-pointer" src={selectedFile} alt="" onClick={()=>setSelectedFile(null)}/>
                                : 
                                <div
                                ...
                                <div className="mt-5 sm:mt-6">
                                    <button disabled={!selectedFile} className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700
                                    focus:outline-none focus:ring-2 focus:ring-offset-2 focus: ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed hover:disabled:bg-gray-300" onClick={uploadPost}>
